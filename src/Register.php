...
<body>
    <form name="registerForm" method="post" action="registerReg.php">
        <fieldset>
            <p><input type="text" autocomplete="off" id="username" name="username" placeholder="昵称(至少5位字母数字下划线组合,以字母开头)" pattern="^[a-zA-Z][a-zA-Z0-9_]{4,}$" required></p>
            <p><input type="password" autocomplete="off" id="pword" name="password" placeholder="密码(至少6位)" pattern="^[a-zA-Z0-9.]{6,}$" required></p>
